                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                // mengecek apakah siswa sudah punya nilai
                                    ...
                                    <table class="table table-sm table-bordered">
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" style="background: #F5F5F5;"><?php if ($dataNilai['nilai_keterampilan'] >= 90) {
                                                    echo 'A';
                                                ...
                                                <td class="text-center" style="background: #F5F5F5;"><?php if ($dataNilai['nilai_pelajaran'] >= 90) {
                                                    echo 'A';
                                ...
                                <?php } else{
                                    echo "<h1 style='text-align : center; color:red;'>Belum Ada Nilai</h1>";
                                }?>
                            </div>
                        </div>
                    </div>
